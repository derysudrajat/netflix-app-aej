package id.derysudrajat.netflix.data
...
object MovieDatasource {
    fun getNowPlayingMovie(): List<Movie> = listOf(
        Movie(
            ...
            7.2f, R.drawable.backdrop_1, R.drawable.poster_1
        ),
        Movie(
            ...
            6.9f, R.drawable.backdrop_2, R.drawable.poster_2
        ),
        Movie(
            "Black Panther: Wakanda Forever",
            "Queen Ramonda, Shuri, M’Baku, Okoye and the Dora Milaje fight to protect their nation from intervening world powers in the wake of King T’Challa’s death. As the Wakandans strive to embrace their next chapter, the heroes must band together with the help of War Dog Nakia and Everett Ross and forge a new path for the kingdom of Wakanda.",
            7.5f, R.drawable.backdrop_3, R.drawable.poster_3
        ),
        Movie(
            "Smile",
            "After witnessing a bizarre, traumatic incident involving a patient, Dr. Rose Cotter starts experiencing frightening occurrences that she can't explain. As an overwhelming terror begins taking over her life, Rose must confront her troubling past in order to survive and escape her horrifying new reality.",
            6.8f, R.drawable.backdrop_4, R.drawable.poster_4
        ),
        Movie(
            "Terrifier 2",
            ...
            7.0f, R.drawable.backdrop_5, R.drawable.poster_5
        ),
        Movie(
            "Paradise City",
            ...
            5.5f, R.drawable.backdrop_6, R.drawable.poster_6
        ),
        Movie(
            "Medieval",
            ...
            7.3f, R.drawable.backdrop_7, R.drawable.poster_7
        ),
        Movie(
            ...
            5.8f, R.drawable.backdrop_8, R.drawable.poster_8
        ),
        Movie(
            "Enola Holmes 2",
            "Now a detective-for-hire like her infamous brother, Enola Holmes takes on her first official case to find a missing girl, as the sparks of a dangerous conspiracy ignite a mystery that requires the help of friends — and Sherlock himself — to unravel.",
            7.7f, R.drawable.backdrop_9, R.drawable.poster_9
        ),
        Movie(
            ...
            7.8f, R.drawable.backdrop_10, R.drawable.poster_10
        ),
        Movie(
            "Emily the Criminal",
            ...
            6.9f, R.drawable.backdrop_11, R.drawable.poster_11
        ),
        Movie(
            "The Lair",
            ...
            5.9f, R.drawable.backdrop_12, R.drawable.poster_12
        ),
        Movie(
            "On the Line",
            ...
            6.6f, R.drawable.backdrop_13, R.drawable.poster_13
        ),
        Movie(
            "Fall",
            "For best friends Becky and Hunter, life is all about conquering fears and pushing limits. But after they climb 2,000 feet to the top of a remote, abandoned radio tower, they find themselves stranded with no way down. Now Becky and Hunter’s expert climbing skills will be put to the ultimate test as they desperately fight to survive the elements, a lack of supplies, and vertigo-inducing heights",
            7.3f, R.drawable.backdrop_14, R.drawable.poster_14
        ),
        Movie(
            "Im Westen nichts Neues",
            "Paul Baumer and his friends Albert and Muller, egged on by romantic dreams of heroism, voluntarily enlist in the German army. Full of excitement and patriotic fervour, the boys enthusiastically march into a war they believe in. But once on the Western Front, they discover the soul-destroying horror of World War I.",
            7.8f, R.drawable.backdrop_15, R.drawable.poster_15
        ),
        Movie(
            ...
            6.9f, R.drawable.backdrop_16, R.drawable.poster_16
        ),
        Movie(
            "Orphan: First Kill",
            "After escaping from an Estonian psychiatric facility, Leena Klammer travels to America by impersonating Esther, the missing daughter of a wealthy family. But when her mask starts to slip, she is put against a mother who will protect her family from the murderous “child” at any cost.",
            6.8f, R.drawable.backdrop_17, R.drawable.poster_17
        ),
        Movie(
            "The Menu",
            ...
            7.5f, R.drawable.backdrop_18, R.drawable.poster_18
        ),
        Movie(
            "Watcher",
            ...
            6.3f, R.drawable.backdrop_19, R.drawable.poster_19
        ),
        Movie(
            ...
            6.6f, R.drawable.backdrop_20, R.drawable.poster_20
        ),
    )
}